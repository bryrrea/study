...
### 12.4. Accessing elements in a `Map()`  
...
### 12.5. Removing elements from a `Map()`  
...
### 12.7. More used methods with `Map()`  
...
### 13.4. Deleting values from a `Set()`  
...
### 13.5. Verifying values and the size of a `Set()`  
...
### 13.6. `keys()`, `values()` and `entries()` methods  
...
##### **Let's practice!**  
 ...
 - Practice 47 - Create an array called "values" with the following values:
        ...
        Next:
            ...
            4. Print out "results". 
[Solution](/en/js/practicing/p47.js)
